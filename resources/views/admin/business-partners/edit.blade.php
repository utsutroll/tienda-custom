...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Editar Aliado Comercial</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Editar Aliado Comercial</li>
                </ol> 
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Editar Aliado Comercial</h4>
                    <h6 class="card-subtitle"></h6>
                    {!! Form::model($business_partner,['route' => ['admin.business-partners.update', $business_partner], 'method' => 'put', 'autocomplete' => 'off', 'files' => true]) !!}    
