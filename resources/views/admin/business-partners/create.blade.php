...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Nuevo Aliado Comercial</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Menú Principal</a></li>
                    <li class="breadcrumb-item"><a href="{{route('admin.business-partners.index')}}">Listado de Aliado Comercial</a></li>
                    <li class="breadcrumb-item active">Nuevo Aliado Comercial</li>
                </ol> 
            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Registrar Aliado Comercial</h4>
                    <h6 class="card-subtitle">Sigue los pasos para registrar un Aliado Comercial</h6>
                    {!! Form::open(['route' => 'admin.business-partners.store', 'autocomplete' => 'off', 'files' => true]) !!}    
                        
                        @include('admin.business-partners.partials.form')
