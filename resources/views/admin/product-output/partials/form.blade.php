<div class="d-flex justify-content-end">
    <div class="form-group">
        <label for="" class="d-flex justify-content-end">Fecha de Salida</label>
...
<div class="row">
    ...
    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
        <div class="form-group">
            ...
            {!! Form::label('pobservation', 'Observación') !!}
            {!! Form::text('pobservation', null, ['class' => 'form-control', 'min' => '1', 'placeholder' => 'Ingrese la Observación']) !!} 
