<div class="container-fluid">
    ...
    <div class="card">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th wire:click="order('name')" style="cursor:pointer;">Subcategoría
                                {{-- Sort --}}
                                @if ($sort == 'name')
                                    @if ($direcction == 'asc')
                            ...
                            <th wire:click="order('category_id')" style="cursor:pointer;">Categoría
                                {{-- Sort --}}
                                @if ($sort == 'category_id')
                                    @if ($direcction == 'asc')
                                        <i class="fa fa-sort-alpha-asc float-right mt-1"></i>    
        ...
        @elseif (count($subcategories) == 0 & $search !== '')
            <div class="card-body">
