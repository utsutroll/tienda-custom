<div class="container-fluid">
    ...
    @include('livewire.admin.partials.editTag')
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th wire:click="order('name')" style="cursor:pointer;">Etiqueta
                                {{-- Sort --}}
                                @if ($sort == 'name')
                                    @if ($direcction == 'asc')
    ...
    window.livewire.on('tagDeleted_e',()=>{
        ...
        $.toast({
            heading: 'Notificación',
            text: 'La Etiqueta se encuentra asignada a un producto, no puede ser eliminada.',
            position: 'top-right',
            loaderBg:'#ff6849',
            icon: 'error',
            hideAfter: 3500, 
