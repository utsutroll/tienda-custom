<div>
    ...
    <h1 class="text-xl uppercase text-center font-bold py-2 my-3">Categoría: {{$category_name}}</h1>
    ...
    <div class="my-4 text-center">
        <h5 class="text-base text-gray-800">No se Encontraron Productos que Correspondan a la Categoría: {{$category_name}}</h5>
    </div>    
