            ...
            <form wire:submit.prevent="sendPayment">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                    <div class="col-span-2 md:col-span-1 lg:col-span-1">
                        <h5 class="my-2 ml-2 text-lg font-semibold font-sans">Elegir una opción de pago<span
                                class="text-red-500 text-lg font-bold">*</span></h5>
                        <div class="p-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2">
                            <div class="custom-control custom-radio col-span-1">
                                <input type="radio" id="moneys" wire:model="paymentmode" value="money"
                                    class="custom-control-input">
                                <label class="custom-control-label" for="moneys">Efectivo</label>
                            </div>
                            <div class="custom-control custom-radio col-span-1">
                                <input type="radio" id="banks" wire:model="paymentmode" value="bank"
                                    class="custom-control-input">
                                <label class="custom-control-label" for="banks">Cuentas Bancarias</label>
                            </div>
                            <div class="custom-control custom-radio col-span-1">
                                <input type="radio" id="wallets" wire:model="paymentmode" value="wallet"
                                    class="custom-control-input">
                        ...
                        @elseif($paymentmode == "wallet")
                            ...
                            <div class="col-span-2 md:col-span-1 lg:col-span-1">
                                ...
                                <h4 class="text-xl font-semibold font-sans my-4">Información general</h4>
                                <p><span class="text-base font-semibold text-gray-700">Plataforma:</span> {{ $w->name
                                    }}</p>
                                @if ($w->type == "crypto")
                                <p><span class="mb-1 text-base font-semibold text-gray-700">Billetera:</span> {{
                                    $w->wallet_email }}</p>
                                @else
                                <p class="my-2"><span class="text-base font-semibold text-gray-700">Correo Electrónico:</span> {{
                                    $w->wallet_email }}</p>
                                @endif
                                <hr />
                                @endforeach
                    ...
                    @if ($paymentmode != "money" && count($wallets) > 0 || count($banks) > 0)
                    <div class="col-span-2 md:col-span-1 lg:col-span-1">
                        <hr class="md:hidden lg:hidden">
                        <h5 class="my-2 text-center text-lg font-semibold font-sans">Proporcione la Información
                            Solicitada</h5>
                        <div class="p-4">
                            <div class="m-2">
                                <div class="my-2">
                                    <label for="captura" class="font-sans font-semibold text-gray-700">Agregue la
                                        Captura de la Trasnferencia o Pago Móvil (Opcional)</label>
                                    <input type="file"
                ...
                <div class="flex justify-end my-2">
                    <button wire:click.prevent="cancelPayment"
                        class="p-2 mr-2 text-base text-white font-semibold rounded-md bg-red-700 hover:bg-red-900 shadow-lg shadow-red-600">Cancelar</button>
                    <button type="submit"
                        class="p-2 mr-2 text-base text-white font-semibold rounded-md bg-teal-600 hover:bg-teal-800 shadow-lg shadow-teal-600">Comprobar</button>
                </div>
            </form>
        </div>
    </div>
